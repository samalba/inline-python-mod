...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (any, error) {
	...
	case "InlinePython":
		...
		case "Code":
			...
			var code string
			err = json.Unmarshal([]byte(inputArgs["code"]), &code)
			if err != nil {
				fmt.Println(err.Error())
				os.Exit(2)
			}
			return (*InlinePython).Code(&parent, ctx, code)
		case "WithPackage":
			var err error
			var parent InlinePython
			err = json.Unmarshal(parentJSON, &parent)
			...
			return (*InlinePython).WithPackage(&parent, ctx, name)
		case "WithPackages":
			var err error
			var parent InlinePython
			err = json.Unmarshal(parentJSON, &parent)
			...
			return (*InlinePython).WithPackages(&parent, ctx, packages)
		case "":
			var err error
			var typeDefBytes []byte = []byte("{\"asObject\":{\"fields\":[{\"name\":\"Ctr\",\"typeDef\":{\"asObject\":{\"name\":\"Container\"},\"kind\":\"ObjectKind\"}}],\"functions\":[{\"args\":[{\"name\":\"code\",\"typeDef\":{\"kind\":\"StringKind\"}}],\"name\":\"Code\",\"returnType\":{\"asObject\":{\"name\":\"Container\"},\"kind\":\"ObjectKind\"}},{\"args\":[{\"name\":\"name\",\"typeDef\":{\"kind\":\"StringKind\"}}],\"name\":\"WithPackage\",\"returnType\":{\"asObject\":{\"name\":\"InlinePython\"},\"kind\":\"ObjectKind\"}},{\"args\":[{\"name\":\"packages\",\"typeDef\":{\"asList\":{\"elementTypeDef\":{\"kind\":\"StringKind\"}},\"kind\":\"ListKind\"}}],\"name\":\"WithPackages\",\"returnType\":{\"asObject\":{\"name\":\"InlinePython\"},\"kind\":\"ObjectKind\"}}],\"name\":\"InlinePython\"},\"kind\":\"ObjectKind\"}")
